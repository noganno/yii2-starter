	...
	<div class="mobile">
		<div id="sidebar">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a href="/article/?sort=new" aria-expanded="false"><?php echo Yii::t('frontend', 'Новые') ?></a></li>
				<li><a href="/article/?sort=top" aria-expanded="true"><?php echo Yii::t('frontend', 'Топ дня') ?></a></li>
				<li><a href="/article/?sort=read" aria-expanded="false"><?php echo Yii::t('frontend', 'Популярные') ?></a></li>
			</ul>
			...
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 lang">
				<ul>					
					<?php if(\Yii::$app->language == 'uz') { ?>
						<li class="dropdown1" id="uzbek">
				 		<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
						aria-expanded="false" style="margin-left:24px">Узбекский <span class="caret"></span></a>
						...
						<li class="dropdown1" id="russian1">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
								aria-expanded="false" style="margin-left:24px">Русский <span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
										<li><a href="/site/set-locale?locale=uz-UZ">Узбекский</a></li>
									</ul>
						</li>
								<?php } ?>
							</ul>
					...
					<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
						<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 lang">
							<ul>
								...
								<li class="dropdown" id="uzbek">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
									   aria-expanded="false">Узбекский <span class="caret"></span></a>
									<ul class="dropdown-menu" role="menu">
										<li><a href="/site/set-locale?locale=ru-RU">Русский</a></li>
									</ul>
								</li>
						...
						<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 buttons">
							<?php
								...
								if ($guest) { ?>
									<a href="/user/sign-in/login" class="enter_btn btn"><?php echo Yii::t('frontend', 'Login') ?></a>
									<a href="/user/sign-in/signup" class="registration_btn btn"><?php echo Yii::t('frontend', 'Signup') ?></a>
								<?php } else { ?>
