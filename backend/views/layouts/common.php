                    ...
                    'items'=>[
                        ...
                        [
                            ...
                            'items'=>[
                                ...
                                ['label'=>Yii::t('backend', 'Quote'), 'url'=>['/quote/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                                ...
                                ['label'=>Yii::t('backend', 'Push Notifications'), 'url'=>['/push/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
